              ...
              <>
                ...
                <div className="p-4 border-gray-200 border-b">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="font-semibold text-xl">{currentTemplate.metadata?.name || 'Template'}</h3>
                      <p className="text-gray-600">{currentTemplate.metadata?.description || 'No description'}</p>
                    </div>
                        ...
                        <div>
                          ...
                          <div className="gap-4 grid grid-cols-2">
                            <div>
                              ...
                              <input
                                type="number"
                                value={currentTemplate.execution_settings?.max_tokens || 1000}
                            ...
                            <div>
                              ...
                              <input
                                ...
                                min="0"
                                max="2"
                                value={currentTemplate.execution_settings?.temperature || 0.7}
                            ...
                            <div>
                              ...
                              <input
                                ...
                                min="-2"
                                max="2"
                                value={currentTemplate.execution_settings?.frequency_penalty || 0}
